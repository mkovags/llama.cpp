...
ggml.o: src/ggml/ggml.c src/ggml/ggml.h
	$(CC)  $(CFLAGS)   -c ggml.c -o ggml.o

llama.o: src/llama/llama.cpp src/llama/llama.h
...
main: src/main.cpp ggml.o llama.o utils.o
	$(CXX) $(CXXFLAGS) main.cpp ggml.o llama.o utils.o -o main $(LDFLAGS)
	@echo
	@echo '====  Run ./main -h for help.  ===='
	@echo

quantize: src/quantize/quantize.cpp ggml.o llama.o utils.o
